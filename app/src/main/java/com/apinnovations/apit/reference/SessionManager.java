package com.apinnovations.apit.reference;
...
public class SessionManager {
    ...
    private static final String KEY_STATUS_CK = "chkd_true";
    ...
    {
        editor.putBoolean(KEY_STATUS_CK, status);
        editor.commit();
    }

    public Boolean getChkBxStatus() {
        return shref.getBoolean(KEY_STATUS_CK, false);
    }
   ...
   /* public void clearEnquiryForm()
    ...
    public String getKeyTokenId() {
        return shref.getString(KEY_TOKEN_ID, null);
    }
